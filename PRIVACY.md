...
does. Please refer to the privacy policy on their website for details.

## Changes to this Policy
This policy may change over time so please check back periodically.

As no information is collected by, nor required to use, the application it is not possible for us to proactively notify
